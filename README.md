...
Metal and traefic configuration based on thorium's description «[Local Kubernetes cluster with flannel, metallb and traefik](https://github.com/Thoorium/kubernetes-local-cluster-flannel-metallb-traefik/tree/master)».
